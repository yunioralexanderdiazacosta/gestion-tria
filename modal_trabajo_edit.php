                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" id="estudiante_id" data-live-search="true">
                                ...
                                <?php
                                $sql_estudiantes = $con->query("SELECT * FROM estudiantes WHERE id NOT IN (SELECT e.id FROM estudiantes e INNER JOIN trabajos t ON e.id = t.estudiante_id WHERE t.estatus = 1 OR t.estatus = 0) ORDER BY nombres ASC, apellidos ASC");
